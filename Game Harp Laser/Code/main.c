...
Esses dados são armazenados na memoria EEPROM INTERNA
*/
...
void main()
{
   ...
   //CODIGO PARA GRAVAR ALGUNS RECORDS INICIAIS, É executado apenas quando o codigo de programa é gravado, pois a memoria eeprom é resetada para o original.
   int valor = 0;
...
//DURAÇÃO NOTAS DAS MUSICAS, CADA LINHA REPRESENTA UMA MUSICA                      
   ...
   //CRIA INDEXADORES QUE MARCAM AS POSIÇOES DE INICIO E FIM DAS MUSICAS NOS VETORES "NOTAS" E "DURACAO" 
...
int listaMusicas(){
   ...
   while(flag_control){
      ...
      //SE ALGUM BOTAO FOI PRESSIONADO DEPOIS SOLTO, UM DESSES IFs SERÁ ACIONADO
